...
const Footer = () => {
  ...
  const email = 'hello@shreeraamjewellery.com';
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <div className="footer-logo-row">
              <div className="footer-logo-box">
                <span className="footer-logo-text">SRJ</span>
              </div>
              <h3>Shree Raam Jewellery</h3>
            </div>
            <p className="footer-brand-desc">
              Crafting timeless heirlooms and personalised silver art since 1998. Where tradition meets contemporary elegance.
            </p>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-list">
              ...
              <li>
                <a href="#personalised" className="footer-link">
                  <span className="footer-link-dot"></span>
                  Personalised Art
                </a>
              </li>
          ...
          <div className="footer-cta">
            ...
            <p className="footer-cta-text">
              Ready to create your perfect piece? Chat with us on WhatsApp for instant assistance.
            </p>
            <a
            ...
            >
              <svg className="footer-whatsapp-icon" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="footer-divider">
          <div className="footer-bottom">
            <p className="footer-copyright">
              © {new Date().getFullYear()} Shree Raam Jewellery. All rights reserved.
            </p>

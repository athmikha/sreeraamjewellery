...
const collectionSubtitle = (category) => {
  const map = {
    Rings: 'Elegant rings for every occasion',
    Necklaces: 'Stunning necklaces to adorn your beauty',
    Earrings: 'Beautiful earrings for every style',
    Bracelets: 'Graceful bracelets to complement your look',
    Bangles: 'Traditional and modern bangles',
    Pendants: 'Exquisite pendants with intricate designs',
    Anklets: 'Delicate anklets for a graceful touch',
    'Gift Items': 'Perfect gifts for your loved ones',
    Coins: 'Premium gold and silver coins',
    'Lord Idols': 'Sacred idols crafted with devotion',
    'Personalised Silver Art': 'Engraved gifts made to order',
  }
  return map[category] || 'Explore our signature collection'
}
